            ...
            <div className="container" id="full-fit">
                ...
                <div className="container" style={{ width: `35%`, height: `100%`, float: `left` }}>
                    <div className="container" id="center-text" style={{ width: `100%`, height: `65%` }}>
                        ...
                        <div className="container" id="center-text" style={{ width: `70%`, height: `84%`, overflowX: `auto`, overflowY: `auto`, borderStyle: `groove`, textAlign: `center`, borderRadius: `12px`, display: `flex`, position: `relative`, marginLeft: `auto`, marginRight: `auto`, justifyContent: `center` }}>
                            <ul id="center-text">
