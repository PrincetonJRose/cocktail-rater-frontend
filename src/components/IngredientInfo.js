                ...
                <Grid  >
                    <GridRow centered>
                        <GridColumn textAlign="centered" centered width={8}>
                            <p></p>
                            <Segment raised style={{ borderStyle: `groove`, borderColor: `pink`, borderRadius: `12px` }}>
                                <h1><u>{i.name}</u></h1>
                            </Segment>
                        </GridColumn>
                    </GridRow>
                    ...
                    <GridRow stretched centered >
                        ...
                        <Segment raised className="container" style={{ borderStyle: `groove`, borderRadius: `12px`, borderColor: `pink`, alignItems: `center` }}>
                            <Segment raised fluid style={{ marginLeft: `auto`, marginRight: `auto`, marginBottom: `auto`, marginTop: `auto`, display: `flex`, justifyContent: `center` }}>
